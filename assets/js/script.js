...
const finalResult = document.querySelector("final-result"); /** to be added */
const endGame = document.querySelector("end-game"); /** to be added */
const newGame = document.querySelector("new-game"); /** to be added */
